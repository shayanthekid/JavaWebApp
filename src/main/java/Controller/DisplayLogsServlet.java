 ...
 * @author sajid
 */
public class DisplayLogsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try (PrintWriter out = response.getWriter()) {
            ...
            Logger_controller Loggercontroller = new Logger_controller();

            // Call the displayAllItems method and get the list of inventory items
            List<Log> items = Loggercontroller.displayLogs();
